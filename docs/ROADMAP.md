...
- Begin Sega CD research and staged architecture work: disc image parsing, BIOS boot, sub-68000 scheduling, Word RAM, CDD/CDC, PCM/CD-DA audio, graphics ASIC, and compatibility dashboards.
...
- Sega CD support is planned but not implemented yet. The first target is BIOS/CD-player boot, followed by Sonic CD title-screen bring-up.
